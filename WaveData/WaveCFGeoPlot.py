...
HourlyData=np.load('WaveEnergyRM3.npz')

HourWaveEnergy=HourlyData["EnergyPu"]
...
plt.scatter(LatLong[:,1],LatLong[:,0],c=AvgWaveEnergy, s=0.2, cmap='jet')
...
plt.title("Wave Energy Sites")

plt.savefig('CF_WaveNC_2000_2009.png',dpi=700)